...
# ifdef ICE_DIAGS
#  ifdef ICE_ALBEDO
        IF (.not.got_var(idIalbO).and.Hout(idIalbO,ng)) THEN
...
#  endif
     ...
     &                                  TRIM(ncname)
          ...
          RETURN
        END IF
        IF (.not.got_var(idIqlwi).and.Hout(idIqlwi,ng)) THEN
